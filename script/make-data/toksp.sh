...
#  cp corpus/iwslt2016/$data.tok.cs $iwslt/$data.sp.cs
#  cp corpus/iwslt2016enar/$data.tok.ar $iwsltenar/$data.sp.ar
#  done
#
...
#  cp corpus/kftt/$data.tok.ja $kftt/$data.sp.ja
#done
#
...
python3 script/make-3vocab.py --min_count 2 < $iwslt/train.sp.cs > $iwslt/train.sp.3vocab.cs
python3 script/make-3vocab.py --min_count 2 < $iwsltenar/train.sp.ar > $iwsltenar/train.sp.3vocab.ar
python3 script/make-3vocab.py --min_count 2 < $kftt/train.sp.ja > $kftt/train.sp.3vocab.ja
